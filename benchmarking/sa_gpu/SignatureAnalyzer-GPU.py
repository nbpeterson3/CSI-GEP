...
def main():
    ...
    parser.add_argument('--max_iter', help='maximum iterations', required=False, default=10, type=int)
    ...
    if args.parameters_file != None:
        ...
        nsig = write_output(W,H,mask,data.channel_names,data.sample_names,args.output_dir,'output')
